...
{
	public  static final String KEY = "34 66 36 65 36 35 35 35 36 63 37 34 37 32 36 31 35 34 36 35 36 33 36 38 33 32 33 30 33 32 33 30";
    ...
    public static String encryptData(String text, String hexKey) throws Exception
    {
        ...
        String hmacHexStr = AESEncryption.__computeHMAC(hexIV, cipherHexStr, hexKey, hmacHexKey);
    ...
    //    System.out.println(hexStr+ "    ::xStr.length() _______________\n "+hexStr.length() );
        if (hexStr.length() > 128)
        {
            ...
            String computedHmacHexStr = AESEncryption.__computeHMAC(hexIV, cipherHexStr, hexKey, hmacHexKey);
        //    System.out.println("computedHmacHexStr_________________\n"+computedHmacHexStr);

            if (computedHmacHexStr.equalsIgnoreCase(hmacHexStr))
            {
                String decryptedStr = __decryptData(cipherHexStr, hexKey, hexIV);
                
      //          System.out.println("decryptedStr_______________________\n"+decryptedStr);

                byte[] data = dataFromHexString(decryptedStr);
                plainText = new String(data, Charset.forName("UTF-8"));
            }
        }
  //      System.out.println("plainText_________________\n"+plainText);
        return plainText;
    }
    ...
    private static String __computeHMAC(String hexIV, String cipherHexStr, String hexKey, String hmacHexKey) throws Exception
    {
        ...
        String hashHexStr = AESEncryption.dataToHexString(hashbytes);
